...
public class Auto_BangTurnByGyroNoStop extends Command {
   ...
   **/
  public Auto_BangTurnByGyroNoStop(double leftThrottle, double rightThrottle, double heading_deg) {
   ...
   **/
  public Auto_BangTurnByGyroNoStop(double leftThrottle, double rightThrottle, double heading_deg, double headingTol) {
    requires(Robot.subChassis);
    requires(Robot.subGyro);
    _leftThrottle = leftThrottle;
    _rightThrottle = rightThrottle;
