...
public static final double launcherMaxRPM = SmartDashboard.getNumber("Launcher Velocity", 2850);//2850//3800 for basketball
    ...
    public void runFlyWheel(){
        flywheelPIDC.setReference(launcherMaxRPM, ControlType.kVelocity);
