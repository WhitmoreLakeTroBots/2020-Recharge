 ...
 */
public class subSmartMotion extends TimedRobot {
  ...
  public subSmartMotion() {
     ...
     */
    subChassis.leftDrive.restoreFactoryDefaults();

    // initialze PID controller and encoder objects
    m_pidController = subChassis.leftDrive.getPIDController();
    m_encoder = subChassis.leftDrive.getEncoder();
